...
NSString *const MJRefreshFooterRefreshing = @"至尊嫱少正在鸡头白脸加载数据...";

NSString *const MJRefreshHeaderPullToRefresh = @"嫱少可以帮你刷新";
NSString *const MJRefreshHeaderReleaseToRefresh = @"嫱少:你松开我";
NSString *const MJRefreshHeaderRefreshing = @"至尊嫱少正在鸡头白脸刷新...";
