...
#define XIANGQING @"http://mapi.yinyuetai.com/playlist/show.json?D-A=0&id=%@&%@"
#define PINGLUN @"http://mapi.yinyuetai.com/playlist/comment/list.json?D-A=0&v=2&id=%@&offset=0&size=%ld&%@"
//http://mapi.yinyuetai.com/playlist/show.json?D-A=0&id=4029318&deviceinfo=%7B%22aid%22%3A%2210201027%22%2C%22os%22%3A%22Android%22%2C%22ov%22%3A%224.4.4%22%2C%22rn%22%3A%22480*800%22%2C%22dn%22%3A%22m1%20note%22%2C%22cr%22%3A%2246002%22%2C%22as%22%3A%22WIFI%22%2C%22uid%22%3A%2252d8f6fa4d7e20415c571f5c81a9070f%22%2C%22clid%22%3A110008000%7D
@interface ImportantViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    UIView * _allView;
...
-(void)createPlayButton{
    ...
    NSString * str=[[_MVArray firstObject]objectForKey:@"url"];
//    NSLog(@"%@",_MVArray);
//    NSLog(@"1%@",str);
...
-(void)createNetDataSource{
    ...
    [manager GET:[NSString stringWithFormat:XIANGQING,self.IDString,deviceinfo] parameters:nil success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        _MVArray=[_miaoshuDic objectForKey:@"videos"];
//        NSLog(@"%@",_MVArray);
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (tableView.tag==10) {
        ...
        CGFloat h=[ImportantViewController heightWith:neiRong];
        return h + 95;
    }else{
        return 100;
    }
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tableView.tag==10) {
        ...
        CGFloat height=[ImportantViewController heightWith:[dictionary objectForKey:@"content"]];
